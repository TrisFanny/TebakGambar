...
public class RantaiActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_rantai);
	...
	public void cekjawaban(View y){
    	String jawabanBenar = "RANTAI MAKANAN";
    	...
    	if(jawabanUser.equals(jawabanBenar)){
    		...
    		Intent i = new Intent(getApplicationContext(),SilsilahActivity.class);
    		startActivity(i);
    	}
    	else{
    		//pesan toast
