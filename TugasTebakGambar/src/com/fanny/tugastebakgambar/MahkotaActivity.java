...
public class MahkotaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mahkota);
	...
	public void cekjawaban(View y){
    	String jawabanBenar = "MAHKOTA DUNIA";
    	...
    	if(jawabanUser.equals(jawabanBenar)){
    		...
    		Intent i = new Intent(getApplicationContext(),SetrikaActivity.class);
    		startActivity(i);
    	}
    	else{
    		//pesan toast
