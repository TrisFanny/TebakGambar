...
public class PerangkapActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_perangkap);
	...
	public void cekjawaban(View y){
    	String jawabanBenar = "PERANGKAP TIKUS";
    	...
    	if(jawabanUser.equals(jawabanBenar)){
    		...
    		Intent i = new Intent(getApplicationContext(),PulauActivity.class);
    		startActivity(i);
    	}
    	else{
    		//pesan toast
